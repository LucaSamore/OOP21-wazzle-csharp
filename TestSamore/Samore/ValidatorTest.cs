...
namespace TestSamore.Samore
{
    ...
    public sealed class ValidatorTest
    {
        ...
        public void TestEasy4x4()
        {
            ...
            //test the wrong one
            var words = validator.Validate(wrongLetters);
            Assert.IsTrue(words is null);

            //this set of letters is valid [88 words]
            var goodLetters = new HashSet<ILetter>()
            {
            ...
            //test the good one
            words = validator.Validate(goodLetters);
            Assert.IsFalse(words is null);
        }
        ...
        public void TestHard4x4()
        {
            ...
            //this set of letters is valid [68 words]
            var goodLetters = new HashSet<ILetter>()
            {
                new Letter('i', new Tuple<int, int>(3, 0), 2),
                new Letter('e', new Tuple<int, int>(1, 0), 3),
        ...
        public void TestEasy5x5()
        {
            ...
            var wrongLetters = new HashSet<ILetter>()
            {
                new Letter('e', new Tuple<int, int>(4, 3), 3),
                new Letter('i', new Tuple<int, int>(1, 3), 2),
                new Letter('i', new Tuple<int, int>(0, 1), 2),
                new Letter('s', new Tuple<int, int>(2, 3), 4),
                new Letter('n', new Tuple<int, int>(3, 3), 5),
                new Letter('u', new Tuple<int, int>(4, 1), 6),
                new Letter('s', new Tuple<int, int>(3, 1), 4),
                new Letter('a', new Tuple<int, int>(3, 0), 1),
                new Letter('a', new Tuple<int, int>(2, 0), 1),
                new Letter('e', new Tuple<int, int>(0, 2), 3),
                new Letter('a', new Tuple<int, int>(3, 4), 1),
                new Letter('i', new Tuple<int, int>(4, 0), 2),
                new Letter('e', new Tuple<int, int>(3, 2), 3),
                new Letter('e', new Tuple<int, int>(4, 4), 3),
                new Letter('r', new Tuple<int, int>(0, 4), 3),
                new Letter('o', new Tuple<int, int>(1, 2), 3),
                new Letter('o', new Tuple<int, int>(2, 4), 3),
                new Letter('v', new Tuple<int, int>(2, 2), 6),
                new Letter('x', new Tuple<int, int>(0, 0), 7),
                new Letter('s', new Tuple<int, int>(4, 2), 4),
                new Letter('s', new Tuple<int, int>(1, 0), 4),
                new Letter('w', new Tuple<int, int>(1, 4), 7),
                new Letter('e', new Tuple<int, int>(0, 3), 3),
                new Letter('a', new Tuple<int, int>(2, 1), 1),
            ...
            //this set of letters is valid [198 words]
            var goodLetters = new HashSet<ILetter>()
            {
        ...
        public void TestHard5x5()
        {
            ...
            //this set of letters is valid [121 words]
            var goodLetters = new HashSet<ILetter>()
            {
        ...
        public void TestEasy6x6()
        {
            ...
            {
                new Letter('i', new Tuple<int, int>(4, 1), 2),
                new Letter('e', new Tuple<int, int>(2, 1), 3),
                new Letter('i', new Tuple<int, int>(2, 5), 2),
                new Letter('h', new Tuple<int, int>(1, 5), 7),
                new Letter('i', new Tuple<int, int>(0, 1), 2),
                new Letter('r', new Tuple<int, int>(5, 5), 3),
                new Letter('o', new Tuple<int, int>(3, 1), 3),
                new Letter('o', new Tuple<int, int>(4, 5), 3),
                new Letter('n', new Tuple<int, int>(0, 3), 5),
                new Letter('o', new Tuple<int, int>(3, 3), 3),
                new Letter('s', new Tuple<int, int>(5, 3), 4),
                new Letter('t', new Tuple<int, int>(1, 1), 4),
                new Letter('a', new Tuple<int, int>(0, 2), 1),
                new Letter('a', new Tuple<int, int>(3, 2), 1),
                new Letter('e', new Tuple<int, int>(4, 0), 3),
                new Letter('i', new Tuple<int, int>(5, 4), 2),
                new Letter('i', new Tuple<int, int>(5, 2), 2),
                new Letter('e', new Tuple<int, int>(1, 0), 3),
                new Letter('i', new Tuple<int, int>(1, 4), 2),
                new Letter('p', new Tuple<int, int>(3, 4), 6),
                new Letter('o', new Tuple<int, int>(2, 0), 3),
                new Letter('l', new Tuple<int, int>(4, 2), 6),
                new Letter('t', new Tuple<int, int>(0, 4), 4),
                new Letter('j', new Tuple<int, int>(4, 4), 7),
                new Letter('n', new Tuple<int, int>(2, 4), 5),
                new Letter('i', new Tuple<int, int>(5, 0), 2),
                new Letter('o', new Tuple<int, int>(2, 2), 3),
                new Letter('a', new Tuple<int, int>(0, 5), 1),
                new Letter('w', new Tuple<int, int>(0, 0), 7),
                new Letter('t', new Tuple<int, int>(3, 0), 4),
                new Letter('a', new Tuple<int, int>(5, 1), 1),
                new Letter('a', new Tuple<int, int>(2, 3), 1),
                new Letter('z', new Tuple<int, int>(1, 2), 7),
                new Letter('a', new Tuple<int, int>(1, 3), 1),
                new Letter('a', new Tuple<int, int>(3, 5), 1),
                new Letter('a', new Tuple<int, int>(4, 3), 1)
            };
            ...
            //this set of letters is valid [270 words]
            var goodLetters = new HashSet<ILetter>()
            {
                new Letter('i', new Tuple<int, int>(2, 1), 2),
        ...
        public void TestHard6x6()
        {
            ...
            //this set of letters is valid [153 words]
            var goodLetters = new HashSet<ILetter>()
            {
